                    ...
                    <div class="card-content">
                        <form method="post" action="">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="text" class="form-control" name="asal_sekolah" value="<?php isset($_SESSION['asal_sekolah'])  ?  print($_SESSION['asal_sekolah']) : ""; ?>" required>
                                    </div>
                                </div>
                            </div>
                            <!-- end input tk-nama -->

                            <!-- start input tk-nilai -->
                            ...
                            <!-- <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group label-floating">
                                        <label class="control-label">tinggal bersama (orang tua/wali)</label>
                                        <input type="text" class="form-control" name="tinggal_bersama" value="<?php isset($_SESSION['tinggal_bersama'])  ?  print($_SESSION['tinggal_bersama']) : ""; ?>" required>
                                    </div>
                                </div>
                            </div> -->
