                    ...
                    <div class="card-content">
                        <form method="post" action="">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group label-floating">
                                        <label class="control-label">Tanggal lahir Calon peserta Didik</label>
                                        <?php
                                        // 
                                        // 
                                        $min = date('Y-m-d', strtotime("-6 years 3 months"));
                                        $max = date('Y-m-d', strtotime("-8 years"));
                                        // echo var_dump($min);
                                        // die();
                                        ?>
                                        <input max="<?= $min ?>" min="<?= $max ?>" type="date" class="form-control" name="birth_date" value="<?php isset($_SESSION['birth_date'])  ?  print($_SESSION['birth_date']) : print($max); ?>" required>
                                    </div>
                                </div>
                            </div>
