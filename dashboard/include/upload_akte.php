...
if (isset($_POST['upload'])) {
    ...
    if ($file_type=="image/png" || $file_type=="image/jpeg") {
...

         {
            ...
            if ($exec) {
             echo "<div class='alert alert-success alert-dismissable'>
              ...
              <strong>Berhasil!</strong> Upload Akte(JPEG, PNG).
            </div>";   
            }
     ...
     echo "<div class='alert alert-danger alert-dismissable'>
          <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
          <strong>Gagal!</strong> Upload Akte harus format(.JPEG, PNG).
        </div>";

    }

    if ($file_type2=="image/png" || $file_type2=="image/jpeg") {
        if(move_uploaded_file($_FILES['foto2r']['tmp_name'], $targetfolder2))

         {
            ...
            if ($exec) {
                echo "<div class='alert alert-success alert-dismissable'>
                  <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
                  <strong>Berhasil!</strong> Upload Kartu Keluarga(JPEG, PNG).
                </div>";                
            }
         ...
         echo "<div class='alert alert-danger alert-dismissable'>
          <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
          <strong>Gagal!</strong> Upload Kartu Keluarga(JPEG, PNG).
        </div>";
        ...
        echo "<div class='alert alert-danger alert-dismissable'>
          <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
          <strong>Gagal!</strong> Upload Kartu Kelarga harus format(JPEG, PNG).
        </div>";
    }
    ...
    <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
        <div class="card" style="margin-top: 50px">
            <div class="card-header" data-background-color="blue">
                <h4 class="title">Upload Akte(JPEG, PNG) dan Kartu Keluarga(JPEG, PNG)</h4>
                <p class="category">Upload dengan format yang benar(JPEG, PNG)</p>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="form-group floating-label" style="margin-left: 20px;">
                            <label class="col-sm-12">Akte Kelahiran(JPEG, PNG) : </label>
                    ...
                    <div class="row">
                        <div class="form-group floating-label" style="margin-left: 20px;">
                            <label class="col-sm-12">Kartu Keluarga(JPEG, PNG) : </label>
                            <label class="btn btn-primary" for="my-file-selector2">
                                ...
                                Upload Kartu Keluarga Keluarga (JPEG, PNG)
                            </label>
