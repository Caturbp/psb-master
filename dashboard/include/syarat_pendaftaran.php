    ...
    <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
        <div class="card" style="margin-top: 50px">
            <div class="card-header" data-background-color="blue">
                ...
                <p class="category">Lengkapi syarat pendaftaran dibawah</p>
            </div>
                ...
                <ol>
                    ...
                    <li>
                        ...
                        if ($upload_akte != "" && $upload_kartu_keluarga != "") {
                            ...
                            if ($daftar['status_pendaftaran'] == 1) {
                                echo '<font color="#2ecc71"> Scan akte kelahiran dan kartu keluarga <i class="fa fa-check"></i></font>';
                            } else if ($daftar['status_pendaftaran'] >= 2) {
                                echo '<font color="#2ecc71"> Scan akte kelahiran dan kartu keluarga <i class="fa fa-check"></i></font>';
                            } else {
                                echo '<font color="#2ecc71"> Scan akte kelahiran dan kartu keluarga <i class="fa fa-check"></i></font> <a href="index.php?page=5" class="btn btn-primary btn-sm" title="Upload Akte Kelahiran dan Kartu Keluarga"><i class="fa fa-pencil"></i></a>';
                            }
                        } else {
                            echo 'Scan akte kelahiran dan kartu keluarga  <a href="index.php?page=5" class="btn btn-primary btn-sm" title="Upload Akte Kelahiran dan Kartu Keluarga"><i class="fa fa-upload"></i></a>';
                        }
