...
<a target="_blank" href="include/cetak_jadwal_user.php?id=<?php echo $id ?>" class="btn btn-warning btn-md pull-right"><i class="fa fa-print"></i> Cetak Jadwal</a>
                                          ...
                                          <ul>
                                                ...
                                                ?>
                                                            <li>
                                                                  ...
                                                                  <?php echo date('H:i', $senin['mulai']) . ' - ' . date('H:i', $senin['selesai']) . ' WIB'; ?>
                                                            </li>
                                                <?php
                                                      }
                                                }
